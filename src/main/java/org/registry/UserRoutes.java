...
import org.registry.UserRegistry.User;
                ...
                concat(
                        ...
                        pathEnd(() ->
                                concat(
                                        get(() ->
                                                onSuccess(getUsers(),
                                                        users -> Directives.complete(StatusCodes.OK, users, Jackson.marshaller())
                                                )
                                        ),
                                        post(() ->
                                                entity(
                                                        ...
                                                        user ->
                                                                onSuccess(createUser(user), performed -> {
                                                                    ...
                                                                    return Directives.complete(StatusCodes.CREATED, performed, Jackson.marshaller());
                                                                })
                                                )
                                        )
                                )
                                ...
                                concat(
                                        ...
                                        delete(() ->
                                                        ...
                                                        onSuccess(deleteUser(name), performed -> {
                                                                    ...
                                                                    return Directives.complete(StatusCodes.OK, performed, Jackson.marshaller());
                                                                }
                                                        )
                                                //#users-delete-logic
                                        )
